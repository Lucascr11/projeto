...
public class PostsDAO {
        ...
        public void insertPosts(Posts po) {
            ...
            String sql = "INSERT INTO transportes(conteudo, data)"
                                + "VALUES(?, ?)";
            
            //Objeto para preparar o envio da query ao banco de dados
            try {
                PreparedStatement prep = conn.prepareStatement(sql);
                prep.setText(1, po.getConteudo());
                prep.setDate(2, po.getData());
        ...
        public ArrayList<Posts> listPosts() throws SQLException{
            ...
            while(result.next()){
              ...
              p.setConteudo(result.getText("conteudo"));
              p.setData(result.getData("data"));
        ...
        public Posts listOnePosts(int id) throws SQLException {
            ...
            if(result.next()){
                ...
                pos.setConteudo(result.getText("conetudo"));
                pos.setData(result.getDate("data"));
            }
        ...
        public void updatePosts(Posts p) throws SQLException {
            ...
            prep.setText(1, p.getConteudo());
            prep.setDate(2, p.getData());
